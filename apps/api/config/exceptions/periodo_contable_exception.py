...
class InvalidNameByFileException(BasePeriodoContableException): ...

class MissingColumnsByFileException(BasePeriodoContableException): ...

class MissingConceptsByFileException(BasePeriodoContableException): ...
